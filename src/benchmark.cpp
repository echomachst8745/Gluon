...
void RunPerftTestPositions()
{
	...
	static const int totalTestsNum = 4;

	static const int testFenDepths[] = { 6, 8, 6, 5 };

	static const std::uint64_t testPerftExpectedResults[] = { 8031647685ULL, 3009794393ULL, 706045033ULL, 89941194ULL };
